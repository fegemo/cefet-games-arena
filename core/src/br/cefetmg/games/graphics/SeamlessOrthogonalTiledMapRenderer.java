 ...
 * @author fegemo
 */
public class SeamlessOrthogonalTiledMapRenderer extends OrthogonalTiledMapRenderer {

    public SeamlessOrthogonalTiledMapRenderer(TiledMap map, SpriteBatch batch) {
        super(map, batch);
    }
